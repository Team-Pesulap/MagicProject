...
async def add_ubot(client: Client, msg: Message):
    ...
    try:
        ...
        # Change this directory according to your repository
        client = Client(name="ubot", api_id=API_ID, api_hash=API_HASH, session_string=phone, plugins=dict(root="Magic/plugins"))
        await client.start()
